...
<head>
    ...
    <title>@yield('meta_title')Banglamark limited</title>
                ...
                <div class="header-column">
                    <div class="header-row">
                        <div class="header-logo">
                            <a href="{{url('/')}}">
                                <img alt="Banglamark" width="150" height="120" data-sticky-width="100" data-sticky-height="80" src="{{asset('theme/front/img/logo_v2.png')}}" style="margin: -10px;">
                            </a>
                        </div>
                    </div>
                </div>
                                    ...
                                    <ul class="nav nav-pills" id="mainNav">
                                        ...
                                        <li class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li><a class="dropdown-item" href="{{url('/about-sister-concerns')}}">Our Sister Concerns</a></li>
                                                <li><a class="dropdown-item" href="{{url('/news-activities')}}">News & Activities</a></li>
                                            </ul>
                                        </li>
                                       ...
                                       <!-- <li class="dropdown">
                                            <a class="dropdown-item dropdown-toggle" href="#">IT Business</a>
                                            <ul class="dropdown-menu">
                                                <li><a class="dropdown-item" href="{{url('/information-technology/e-business-solution')}}">E-Business Solution</a></li>
                                                <li><a class="dropdown-item" href="{{url('/information-technology/fintech-solution')}}">FinTech Solution</a></li>
                                                <li><a class="dropdown-item" href="{{url('/information-technology/coupon-deal-platform')}}">Coupon & Deal Platform</a></li>
                                                <li><a class="dropdown-item" href="{{url('/information-technology/ride-sharing-service')}}">Ride Sharing Service</a></li>
                                                <li><a class="dropdown-item" href="{{url('/information-technology/on-demand-service')}}">On Demand Service</a></li>
                                            </ul>
                                        </li>-->
                                        
                                        
                                        <li class="dropdown dropdown-mega"> <a class="dropdown-item dropdown-toggle" href="https://bhibanglamark.com/">Heavy Industries</a>
                                            <ul class="dropdown-menu">
                                                <li>
                                                    <div class="dropdown-mega-content">
                                                        <div class="row">
                                                             @foreach($menus as $index1=>$value1)
                                                             @if($index1 == 4 || ($index1 > 5 && $index1 < 8))
                                        ...
                                        <li class="dropdown">
                                            <a class="dropdown-item dropdown-toggle" href="https://banglamarkagro.com/">Agro Solution</a>
                                            <ul class="dropdown-menu">
                                                <li><a class="dropdown-item" href="{{url('/agro/agro-machinery')}}">Agro Machinery</a></li>
                                                <li><a class="dropdown-item" href="{{url('/agro/Crop-protection-solution')}}">Crop protection solution</a></li>
                                                <li><a class="dropdown-item" href="{{url('/agro/Plant-Growth-Regulators')}}">Plant Growth Regulators </a></li>
                                                <li><a class="dropdown-item" href="{{url('/agro/Fertilizer')}}">Fertilizers</a></li>
                                                <li><a class="dropdown-item" href="{{url('/agro/Seed-treatment')}}">Seed treatment</a></li>
                                                <li><a class="dropdown-item" href="{{url('/agro/pesticide')}}">Pesticide</a></li>
                                                ...
                                                <li>
                                                    <div class="dropdown-mega-content">
                                                        <div class="row">
                                                             ...
                                                             @if($index2 > 7 && $index2 < 10 || $index2 == 11)
                                                ...
                                                <li>
                                                    <div class="dropdown-mega-content">
                                                        <div class="row">
                                                             ...
                                                             @if($index3 > 10 && $index3!=13 && $index3 < 16)
                                        ...
                                        <li class="dropdown">
                                            <a class="dropdown-item dropdown-toggle" href="{{url('/contact-us')}}">Contact</a>
                                            <ul class="dropdown-menu">
                                                <li><a class="dropdown-item" href="{{url('/banglamark-career')}}">BANGLAMARK CAREER</a></li>
                                            </ul>    
        ...
        <div class="row pt-5 pb-2">
            ...
            <div class="col-md-6 col-lg-3 mb-lg-0 vfooter">
                ...
                <ul class="list list-icons list-icons-lg ">
                    ...
                    <li class="mb-1"><i class="fas fa-caret-right text-color-primary vfooter-arrow"></i>
                        <p class="m-0 pt-0"><a href="{{url('/warehouse')}}">Wearhouse</a></p>
                    </li>
                    <li class="mb-1"><i class="fas fa-caret-right text-color-primary vfooter-arrow"></i>
